...
// based on processor selected in MPLAB
		...
		#define PICDEMNET2
	#elif defined(__18F67J60) || defined(_18F67J60) || defined(__18F66J60) || defined(_18F66J60)
...
// Set configuration fuses (but only once)
			...
			//#pragma config WDT=OFF, FOSC2=ON, FOSC=HSPLL, ETHLED=ON, MCLRE=ON
...
// PICDEM HPC Explorer + Ethernet PICtail
	...
	#define ENC_SPICON1			(SSP1CON1)
	#define ENC_SPICON1bits		(*((SSPCON1bits*)&SSP1CON1))
	#define ENC_SPICON2			(SSP1CON2)
	...
	#define EEPROM_SPICON1		(SSP1CON1)
	#define EEPROM_SPICON1bits	(*((SSPCON1bits*)&SSP1CON1))
	#define EEPROM_SPICON2		(SSP1CON2)
	#define EEPROM_SPISTAT		(SSP1STAT)
...
// PICDEM.net 2 (PIC18F97J60 + ENC28J60) + HI-TECH PICC-18 compiler
	...
	#define SSP1CON1bits		(*((SSPCON1bits*)&SSP1CON1))
	#define SSP1CON2bits		(*((SSPCON2bits*)&SSP1CON2))
...
// Define your own board hardware profile here
	...
	#define SPIRAM_CS_TRIS			(TRISCbits.TRISC2)
//	#define SPIRAM_CS_TRIS			(TRISEbits.TRISE4)
	#define SPIRAM_CS_IO			(LATCbits.LATC2)
//	#define SPIRAM_CS_IO			(LATEbits.LATE4)
	#define SPIRAM_SCK_TRIS			(TRISCbits.TRISC3)
	#define SPIRAM_SDI_TRIS			(TRISCbits.TRISC4)
	#define SPIRAM_SDO_TRIS			(TRISCbits.TRISC5)
	...
	#define	o_Read					PORTDbits.RD0
	#define	o_Write					PORTDbits.RD1
	#define	o_CkSel					PORTDbits.RD2
	
	#define DATABUS					PORTD

	#define	o_CS_MAC				PORTCbits.RC0
	#define o_RC1_Out				PORTCbits.RC1
	#define	o_CS_RAM				PORTCbits.RC2
	#define	o_SerCK					PORTCbits.RC3
	#define	i_SerIn					PORTCbits.RC4
	#define	o_SerOut				PORTCbits.RC5
	#define	o_PicTx					PORTCbits.RC6
	#define	i_PicRx					PORTCbits.RC7

	#define i_Nonce					PORTEbits.RE0
	#define i_Allow					PORTEbits.RE1
	#define o_HwRes					PORTEbits.RE3
//	#define o_SwRes					PORTEbits.RE4

	#define i_FabSet				PORTGbits.RG4


	#define o_LedA					PORTAbits.RA0
	#define o_LedB					PORTAbits.RA1
	#define o_FabLed				PORTAbits.RA2
	#define o_AD_LE					PORTAbits.RA4
	#define o_CH_LE					PORTAbits.RA5

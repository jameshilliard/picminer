...
//char BusyUSART(void) { return !TXSTAbits.TRMT; }
/*	
...
char DataRdyUSART(void)	{ if(RCSTAbits.OERR) { RCSTAbits.CREN = 0; RCSTAbits.CREN = 1; } return PIR1bits.RCIF; }
char ReadUSART(void) { return RCREG; }
*/	
void WriteUSART(char data) { TXREG = data; while(!TXSTAbits.TRMT); }// while(BusyUSART());
